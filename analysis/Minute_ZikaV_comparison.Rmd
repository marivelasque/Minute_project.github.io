...
knitr::opts_chunk$set(cache.path ='Project_PRJNA497590/', warning = FALSE)
...
knitr::opts_chunk$set(
   ...
   fig.height=3,
   fig.align = 'center',
   fig.path='Project_PRJNA497590/figures/') # a unique ID here if you got
```
...
```{r, include=FALSE}
load("RDS/work_PRJNA497590.RData")
cor <- WGCNA::cor
```
...
```{r include=FALSE}
save.image(file = "RDS/work_PRJNA497590.RData")
```
## Session info
```{r}
